...
export default function Batter() {
    ...
    const record = allData.filter((el) => el.category === "Batter")
                    ...
                    <div className='flex flex-wrap border overflow-scroll h-[95%] py-10 px-2 bg-[#f2f3fa] w-[76%]'>
                        {allData &&
                            record.map((e, i) => (
                                <div
                                    key={i}
                                    className='w-[180px] h-[300px] mx-1 my-1 border-[1px] border-gray-300 bg-white shadow-lg rounded-xl overflow-hidden hover:shadow-xl transition-all'
                                >
                                    <img
