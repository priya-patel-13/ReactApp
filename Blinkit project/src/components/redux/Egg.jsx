...
export default function Egg() {
    ...
    const record = allData.filter((el) => el.category === "Eggs")
        ...
        <>
            ...
            <div className='h-[80vh]'>
                ...
                <div className=' flex h-[80vh] w-[85%] ml-[7.5%] mt-[20px] '>
                    ...
                    <div className='flex flex-wrap border overflow-scroll h-[95%] py-10 px-5 bg-[#f2f3fa] w-[76%]'>
                        {allData &&
                            record.map((e, i) => (
                                <div
                                    key={i}
                                    className='w-[180px] mx-1 my-1 h-[300px] border-[1px] border-gray-300 bg-white shadow-lg rounded-xl overflow-hidden hover:shadow-xl transition-all'
                                >
                                    <img
