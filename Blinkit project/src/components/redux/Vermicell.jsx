...
export default function Vermicell() {
    ...
    const record = allData.filter((el) => el.category === "Vermicell")
                    ...
                    <div className="border w-[24%]">
                        <div className=" border  overflow-scroll h-[95%]">
                            <div className="h-[100%] ">
                                ...
                                <Link to="/bread">
                                    <button className="px-5 py-4 w-[100%] h-16 overflow-hidden flex items-center justify-start bg-[#f2f3fa]">
                                        <div className='bg-white text-center rounded-md  h-10 overflow-hidden'>
                                ...
                                <Link to="/vermicell">
                                    <button className="p-5 py-4 w-[100%] h-16 overflow-hidden flex item-center justify-start border-[#0c8222] border-l-4 bg-[#f2f3fa] ">
                                        <div className='bg-white text-center rounded-md  h-10 overflow-hidden'>
