                ...
                <div id="carouselId" className="carousel slide position-relative" data-bs-ride="carousel">
                    <div className="carousel-inner" role="listbox">
                        <div className="carousel-item active rounded">
                            <img src="./img/hero-img-1.png" classNamename="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide"/>
                            <a href="#" classNamename="btn px-4 py-2 text-white rounded">Fruites</a>
                        </div>
                        <div classNamename="carousel-item rounded">
                            <img src="img/hero-img-2.jpg" classNamename="img-fluid w-100 h-100 rounded" alt="Second slide"/>
                            <a href="#" classNamename="btn px-4 py-2 text-white rounded">Vesitables</a>
                        </div>
                    </div>
...
<div classNamename="container-fluid featurs py-5">
    <div classNamename="container py-5">
        <div classNamename="row g-4">
            <div classNamename="col-md-6 col-lg-3">
                <div classNamename="featurs-item text-center rounded bg-light p-4">
                            ...
                            <div className="row g-4">
                                <div className="col-md-6 col-lg-4 col-xl-3">
                                    <div className="rounded position-relative fruite-item">
                                        ...
                                        <div className="text-white bg-secondary px-3 py-1 rounded position-absolute" style={{top: '10px', left: '10px'}}>Frui"ts</div>
